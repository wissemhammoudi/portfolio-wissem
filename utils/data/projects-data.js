export const projectsData = [
  ...
  {
    id: 9,
    name: "Appointment Booking Interface with React & n8n",
    description:
      "Developed a React.js frontend allowing users to view available time slots and book appointments seamlessly. Integrated two n8n workflows: one to fetch available slots from the calendar and another to add a selected slot when the user confirms the appointment. Ensured real-time updates and smooth UX for appointment scheduling.",
    tools: ["React.js", "n8n", "Calendar API", "JavaScript", "Node.js"],
    role: "Full Stack Developer",
